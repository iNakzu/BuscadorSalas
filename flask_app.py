...
def generar_respuesta_gemini(mensaje_usuario, historial=None, imagen=None, dia_detectado=None):
    ...
    contexto_datos = (
        ...
        f"- Lunes:\n"
        f"  * 11:30 - 12:50 | `V432.3.S312` | Tecnologías Inalámbricas | Sec. 1 (Cátedra, Prof. Diego Dujovne) [Estudiante]\n"
        f"  * 13:00 - 14:20 | `E441.2.S201` | Inteligencia Artificial | Sec. 2 (Cátedra, Prof. Víctor Reyes) [Estudiante]\n"
        f"  * 14:30 - 15:50 | `E441.5. LAB INF` | Tecnologías Inalámbricas L. | Sec. 1 (Laboratorio, Prof. Andrés Cruz) [Estudiante]\n"
        ...
        f"- Miércoles:\n"
        f"  * 08:30 - 09:50 | `V432.4.S415` | Tecnologías Inalámbricas A. | Sec. 1 (Ayudantía) [Estudiante]\n"
        f"  * 14:30 - 15:50 | `E441.1.S106` | Introducción a la Economía A. | Sec. 4 (Ayudantía) [Estudiante]\n"
        f"  * 16:00 - 17:20 | `E441.2.S204` | Evaluación de Proyectos TIC A. | Sec. 1 (Ayudantía) [Estudiante]\n"
        f"  * 17:25 - 18:45 | `E441.1.S105` | Arquitecturas Emergentes A. | Sec. 2 (Ayudantía) [Estudiante]\n"
        f"- Jueves:\n"
        f"  * 11:30 - 12:50 | `V432.3.S312` | Tecnologías Inalámbricas | Sec. 1 (Cátedra, Prof. Diego Dujovne) [Estudiante]\n"
        f"  * 13:00 - 14:20 | `E441.2.S201` | Inteligencia Artificial | Sec. 2 (Cátedra, Prof. Víctor Reyes) [Estudiante]\n"
        f"  * 16:00 - 17:20 | `E441.3.S302` | Evaluación de Proyectos TIC | Sec. 1 (Cátedra, Prof. Eduardo Faivovich) [Estudiante]\n"
